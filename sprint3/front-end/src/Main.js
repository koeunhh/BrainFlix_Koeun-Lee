    ...
    return (
      <div className='main'>
        ...
        <div className='controls'>
          <button className='controls__play' onClick={e => this.props.playPause()}>
          ...
          <div className='controls__settings'>
            <button onClick={e => this.props.fullscreen()} className='controls__settings--fullscreen'><img src='/assets/Icons/SVG/Icon-fullscreen.svg' alt='icon-fullscreen'/></button>
